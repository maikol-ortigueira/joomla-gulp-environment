 ...
 * @since  1.6
 */
class TempusModelTranslators extends \Joomla\CMS\MVC\Model\ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
            ...
            $query->from('`#__tempus_translators` AS a');
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_TEMPUS_SEARCH_FILTER_DATE_FORMAT"), "warning");
